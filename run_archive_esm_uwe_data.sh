...
exp_dir="/scratch/m/m300465/tmp/uwe0010_echam"
...
atmos_dat="ATM_mm_ BOT_mm_ co2_ co2_mm_ echam_"
atmos_dat_type="${mm} ${mm} ${no} ${mm} ${no}"
#-------------------------------------------------------------------------#
...
#land_dat="jsbach_ land_ surf_ veg_ yasso_"
#land_dat_type="${dm} ${dm} ${dm} ${dm} ${dm}"
#-------------------------------------------------------------------------#
