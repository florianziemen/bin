...
#
###########################################################################
# File: run_archive_esm_wo_restart_log.sh
#
# This script is used to call the archive script for mpiesm coupled model
# data archive_esm.sh without processing restart and logging data.
#
# Interactive usage:
# ------------------
# ./run_archive_esm_wo_restart_log.sh
#
# Batch job usage on mistral:
# ---------------------------
# sbatch run_archive_esm_wo_restart_log.sh
#
###########################################################################
#
###########################################################################
