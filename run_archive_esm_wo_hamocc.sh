...
#
###########################################################################
# File: run_archive_esm_wo_hamocc.sh
#
# This script is used to call the archive script for mpiesm coupled model
# data archive_esm.sh with the default setup for all model components 
# expect the ocean's biogeochemical one. 
#
# Interactive usage:
# ------------------
# ./run_archive_esm_wo_hamocc.sh
#
# Batch job usage on mistral:
# ---------------------------
# sbatch run_archive_esm_wo_hamocc.sh
#
###########################################################################
#
###########################################################################
