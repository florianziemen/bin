...
#
###########################################################################
# File: run_archive_esm_only_log.sh
#
# This script is used to call the archive script for mpiesm coupled model
# data archive_esm.sh only with processing logging data. 
#
# Interactive usage:
# ------------------
# ./run_archive_esm_only_log.sh
#
# Batch job usage on mistral:
# ---------------------------
# sbatch run_archive_esm_only_log.sh
#
###########################################################################
#
###########################################################################
...
remote_archive_path="bm0948/${USER}/tmp/${mpiesm_id}/${experiment_id}"
#
